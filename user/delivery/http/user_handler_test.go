...
func TestGetByID(t *testing.T) {
	...
	uc := userusecase.New(repo, authorMockRepo, nil)
...
func TestStore(t *testing.T) {
	...
	repo := new(mocks.Repository)
	authorMockRepo := new(authormocks.Repository)
	authorMockSearchEngine := new(mocks.SearchEngine)
	...
	authorMockSearchEngine.On("Store", mock.Anything, mock.AnythingOfType("*model.User")).Return(nil).Once()
	uc := userusecase.New(repo, authorMockRepo, authorMockSearchEngine)
	RegisterHandlers(nil, e, uc)
...
func TestRegister(t *testing.T) {
	...
	uc := userusecase.New(repo, authorMockRepo, searchEngineMock)
