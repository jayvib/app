...
func (_m *Usecase) Fetch(ctx context.Context, cursor string, num int) ([]*model.Article, string, error) {
...
func (_m *Usecase) GetByID(ctx context.Context, id string) (*model.Article, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Usecase) GetByTitle(ctx context.Context, title string) (*model.Article, error) {
...
func (_m *Usecase) Store(ctx context.Context, ar *model.Article) error {
...
func (_m *Usecase) Update(ctx context.Context, ar *model.Article) error {
	ret := _m.Called(ctx, ar)
